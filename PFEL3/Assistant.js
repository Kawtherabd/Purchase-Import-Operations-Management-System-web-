...
function toggleForm2() {
  ...
  var formWrapper = document.getElementById('formWrapper2');
  if (overlay.style.display === 'block') {
    overlay.style.display = 'none';
    formWrapper.style.display = 'none';
  } else {
...
function annuler() {
  toggleForm(); // Appeler la fonction pour fermer le formulaire ou effectuer toute autre action nécessaire pour annuler l'opération.
}
